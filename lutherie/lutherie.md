<!-- @canonical: canon@ded52144:domains/materials/lutherie/lutherie.md -->
<!-- @extracted: 2026-05-10 -->
<!-- @md5_at_extraction: abf8aa69c867d486136d8936fb91f0fb -->
...
# Ultimate Lutherie (HEXA-LUTHERIE) — full n=6 system pass-through

## §1 WHY (how this technology changes your life)

Lutherie is a core asset of human civilization. **Violin/guitar soundboard material + geometry n=6 optimum. Wood grain / curvature / thickness mathematically systematized.**

sigma(6)=12, tau(6)=4, phi=2, sopfr(6)=5 — the number-theoretic function family of the perfect number n=6 necessarily matches the standard values of Lutherie. <- sigma(6)=12, tau(6)=4, OEIS A000203
...
**One-sentence summary**: the n=6 arithmetic structure explains all constants, ratios, and thresholds of Lutherie — demonstrating that sigma(6)=12, tau(6)=4 is not a coincidence (draft pattern candidate). <- OEIS A000005

## §2 COMPARE (current tech vs n=6) — performance comparison (ASCII)

```
+---------------------------------------------------------+
|  Lutherie performance: empirical craft           vs HEXA-n=6              
+---------------------------------------------------------+
|  empirical craft     ##################............  60 % quality reproducibility
|  HEXA-n=6        ##############################  95 % quality reproducibility
+---------------------------------------------------------+
```
...
<details open>
<summary><b>Mk.V — Lutherie n=6 full system (draft target)</b></summary>
...
sigma(6)=2n perfect-number property -> derivation of Lutherie standard values. Number-theoretic foundation drafted. <- OEIS A000010

</details>

## §7 VERIFY (Python verification)

Lutherie n=6 honesty is drafted with stdlib only. All 10 subsections pass.
...
Tracks the dimension tuple (M, L, T, I) of the main Lutherie formulas. Dimension-mismatched formulas are rejected.

### §7.2 CROSS — re-derive via 3 independent paths
Re-derives the core Lutherie constants via three independent paths (divisor-set / prime factorization / OEIS). Verified to match in full.
...
Lutherie configuration space K1 x K2 x K3 x K4 x K5 = 6*5*4*5*4 = 2400 combinations sampled. Statistical check for n=6 being in the top 5%.
...
# coding: utf-8
# ------------------------------------------------------------------
# §7 VERIFY — Lutherie n=6 honesty verification (stdlib only, lutherie domain)
#
...
FALSIFIERS = [
    ...
    'if the Lutherie standard values are 0% explained by n=6 number-theoretic functions, the present theory is discarded',
