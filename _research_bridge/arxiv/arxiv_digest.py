...
raw#10 C3: this module does NOT apply n=6 lattice formulas to arxiv content.
...
def format_markdown(grouped: Dict[str, list]) -> str:
    ...
    out.append("> raw#10 C3: arxiv preprints are CURRENT-RESEARCH SIGNALS, not verified specs.\n")
